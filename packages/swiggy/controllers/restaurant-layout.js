const HomePageItem = require("../models/restaurant-layout");

const restaurantTemplateId = "658403a0f4fc34c3333b6060";
...
const getAllRestaurant = async (req, res) => {
  const restaurants = await HomePageItem.findById({
...
const updateRestaurants = async (req, res) => {
  ...
  const item = await HomePageItem.updateOne(
    {
      _id: restaurantTemplateId,
      "card.card.infoWithStyle.restaurants._id": id,
    },
